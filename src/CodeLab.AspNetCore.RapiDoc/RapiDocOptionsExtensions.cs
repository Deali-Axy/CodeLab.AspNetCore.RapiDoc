...
namespace Microsoft.AspNetCore.Builder
{
    public static class RapiDocOptionsExtensions
    {
        ...
        public static void SwaggerEndpoint(this RapiDocOptions options, string url, string name)
        {
        ...
        /// </summary>
        /// <param name="options"></param>
        public static void EnableDeepLinking(this RapiDocOptions options)
        {
        ...
        /// </summary>
        /// <param name="options"></param>
        public static void DisplayOperationId(this RapiDocOptions options)
        {
        ...
        public static void DefaultModelsExpandDepth(this RapiDocOptions options, int depth)
        {
        ...
        /// <param name="options"></param>
        /// <param name="depth"></param>
        public static void DefaultModelExpandDepth(this RapiDocOptions options, int depth)
        {
        ...
        /// </summary>
        /// <param name="options"></param>
        public static void DisplayRequestDuration(this RapiDocOptions options)
        {
        ...
        public static void DocExpansion(this RapiDocOptions options, DocExpansion docExpansion)
        {
        ...
        public static void EnableFilter(this RapiDocOptions options, string expression = null)
        {
        ...
        public static void MaxDisplayedTags(this RapiDocOptions options, int count)
        {
        ...
        /// </summary>
        /// <param name="options"></param>
        public static void ShowExtensions(this RapiDocOptions options)
        {
        ...
        /// </summary>
        /// <param name="options"></param>
        public static void ShowCommonExtensions(this RapiDocOptions options)
        {
        ...
        public static void SupportedSubmitMethods(this RapiDocOptions options, params SubmitMethod[] submitMethods)
        {
        ...
        public static void OAuth2RedirectUrl(this RapiDocOptions options, string url)
        {
            options.ConfigObject.OAuth2RedirectUrl = url;
        }

        [Obsolete("The validator is disabled by default. Use EnableValidator to enable it")]
        public static void ValidatorUrl(this RapiDocOptions options, string url)
        {
        ...
        /// <param name="options"></param>
        /// <param name="url"></param>
        public static void EnableValidator(this RapiDocOptions options, string url = "https://online.swagger.io/validator")
        {
            options.ConfigObject.ValidatorUrl = url;
        }
        ...
        public static void OAuthClientId(this RapiDocOptions options, string value)
        {
        ...
        /// <param name="options"></param>
        /// <param name="value"></param>
        public static void OAuthClientSecret(this RapiDocOptions options, string value)
        {
        ...
        /// <param name="options"></param>
        /// <param name="value"></param>
        public static void OAuthRealm(this RapiDocOptions options, string value)
        {
        ...
        /// <param name="options"></param>
        /// <param name="value"></param>
        public static void OAuthAppName(this RapiDocOptions options, string value)
        {
        ...
        /// <param name="options"></param>
        /// <param name="value"></param>
        public static void OAuthScopeSeparator(this RapiDocOptions options, string value)
        {
        ...
        /// </summary>
        /// <param name="options"></param>
        public static void OAuthUseBasicAuthenticationWithAccessCodeGrant(this RapiDocOptions options)
        {
        ...
        /// </summary>
        /// <param name="options"></param>
        public static void OAuthUsePkce(this RapiDocOptions options)
        {
